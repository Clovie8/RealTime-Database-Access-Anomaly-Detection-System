...
High-level risk posture (Red/Green status), MTBI trends, and budget justification data.
...
Real-time alerts, IP blacklisting candidates, and attack vector analysis.
...
System performance impact, storage growth of log tables, and false-positive rates.
...
Immutable history of changes to SENSITIVE_TABLE_CONFIG and proof of enforcement.

Monthly/Quarterly (Audit Dump)
