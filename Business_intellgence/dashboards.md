# BI Dashboard Design & Implementation

This document outlines the visual layout, SQL data sources, and the step-by-step Power BI implementation for the project's dashboards.
...
2. Go to **Get Data > Text/CSV**. Load all three CSV files.
3. **Verification:** In "Data View", click on `ALERT_TIME` and `LOGON_TIME` columns. Ensure Data Type is set to Date/Time (not Text).
...
![image alt](https://github.com/Clovie8/RealTime-Database-Access-Anomaly-Detection-System/blob/master/Business_intellgence/BI%20DashBoard.png)
